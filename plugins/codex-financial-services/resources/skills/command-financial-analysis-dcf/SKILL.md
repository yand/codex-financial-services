---
name: "command-financial-analysis-dcf"
description: "Codex adapter for Claude slash command /dcf from financial-analysis. Use when the user types /dcf or asks to build a DCF valuation model with comps-informed terminal multiples"
---
...
Source: `plugins/vertical-plugins/financial-analysis/commands/dcf.md`
