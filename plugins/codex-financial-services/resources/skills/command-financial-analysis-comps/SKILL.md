---
name: "command-financial-analysis-comps"
description: "Codex adapter for Claude slash command /comps from financial-analysis. Use when the user types /comps or asks to build a comparable company analysis with trading multiples"
---
...
# /comps Command Adapter

Source: `plugins/vertical-plugins/financial-analysis/commands/comps.md`
