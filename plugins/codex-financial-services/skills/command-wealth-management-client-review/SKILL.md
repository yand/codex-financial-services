---
name: "command-wealth-management-client-review"
description: "Codex adapter for Claude slash command /client-review from wealth-management. Use when the user types /client-review or asks to prep for a client review meeting"
---
...
# /client-review Command Adapter

Source: `plugins/vertical-plugins/wealth-management/commands/client-review.md`
